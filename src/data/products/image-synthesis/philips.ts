...
export const PHILIPS_PRODUCTS: ProductDetails[] = [
  {
    ...
    description: "AI-powered MR-only simulation solution that generates CT-like density information from MR images for radiation therapy planning in the head and neck region.",
    features: ["MR-only workflow", "Synthetic CT generation", "Radiation therapy planning", "Head and Neck specific", "Deep learning based"],
    ...
    keyFeatures: ["AI-based synthetic CT from MR", "Elimination of CT scans", "Reduced registration errors"],
  ...
  },
  {
    ...
    description: "AI-powered MR-only simulation solution that generates CT-like density information from MR images for radiation therapy planning in the brain region.",
    features: ["MR-only workflow", "Synthetic CT generation", "Radiation therapy planning", "Brain specific", "Deep learning based"],
    category: "Image Synthesis",
    certification: "CE & FDA",
    logoUrl: "/logos/philips.png",
    website: "https://www.usa.philips.com/healthcare",
  ...
  },
  {
    ...
    description: "AI-powered MR-only simulation solution that generates CT-like density information from MR images for radiation therapy planning in the pelvic region.",
    features: ["MR-only workflow", "Synthetic CT generation", "Radiation therapy planning", "Pelvis specific", "Deep learning based"],
    category: "Image Synthesis",
    certification: "CE & FDA",
    logoUrl: "/logos/philips.png",
    website: "https://www.usa.philips.com/healthcare",
