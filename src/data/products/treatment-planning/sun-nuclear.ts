...
export const SUN_NUCLEAR_PRODUCTS: ProductDetails[] = [
  {
    ...
    "suggestedUse": "To provide dosimetric goals and optimization parameters for radiation therapy treatment planning using AI-powered analysis of clinical data.",
    ...
    "regulatory": {
      ...
      "intendedUseStatement": "To provide dosimetric goals and optimization parameters for radiation therapy treatment planning"
    },
    "market": {
